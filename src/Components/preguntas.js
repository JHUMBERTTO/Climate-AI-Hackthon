const preguntas = [
    {
        ...
        opciones: [
            {textoRespuesta: "Agriculture (grower)", value:1, status:false},
    ...
    },
    {
        ...
        opciones: [
            {textoRespuesta: "Almonds", value:1, status:false},
            {textoRespuesta: "Berries", value:1, status:false},
            {textoRespuesta: "Carrots", value:1, status:false},
            {textoRespuesta: "Corn", value:1, status:false},
            {textoRespuesta: "Grapes", value:1, status:false},
            {textoRespuesta: "Onions", value:1, status:false},
            {textoRespuesta: "Pistachios", value:1, status:false},
            {textoRespuesta: "Potatoes", value:1, status:false},
            {textoRespuesta: "Sorghum", value:1, status:false},
            {textoRespuesta: "Sugar", value:1, status:false},
            {textoRespuesta: "Tomatoes", value:1, status:false},
            {textoRespuesta: "Wheat", value:1, status:false}
        ]
